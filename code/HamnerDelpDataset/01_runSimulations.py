...
for subject in subList:
    ...
    ##### TODO: extract data in a way that can be fed into AddBiomechanics pipeline...
    
    ##### TODO: finish code off with a note here that the data from this step is 
    ##### then uploaded into the AddBiomechanics pipeline...
